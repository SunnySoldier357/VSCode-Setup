...
![Step 2 to generate new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/step2.png)

3. A drop down list will pop-up at the top of the screen.
   Always select the *maven-archetype-quickstart* options
   (the 1st one).

![Step 3 to generate new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/step3.png)
...
![Step 5 to generate new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/step5.png)
...
![Step 1 to run new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/debug.png)
...
![Step 2 to run new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/debug2.png)
...
![Step 4 to run new project](https://github.com/SunnySoldier357/VSCode-Setup/tree/master/Images/debug4.png)
